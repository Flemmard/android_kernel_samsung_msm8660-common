...
int pm8901_regulator_pdata_len = 0;
...
static struct msm_board_data msm8x60_pyramid_board_data __initdata = {
...
{
  int mem_size_mb = parse_tag_memsize((const struct tag *)tags);
